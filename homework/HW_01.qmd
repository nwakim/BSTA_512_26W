...
For the regression that you chose as being more appropriate in part (d), find 95% confidence intervals for the true slope and intercept. **Interpret each estimate, including the confidence interval.**
...
For the regression that you chose as being more appropriate in part (d), add 95% confidence bands. Calculate and interpret the mean response of an 8-day-old chick, including a 95% confidence interval.
