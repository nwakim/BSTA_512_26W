...
## Need to include slides on working with and storing datasets {visibility="hidden"}
...
- [Online TB on data science intro](https://hellodata.science/)
...
- You can check out [Dr. Meike's R class page](https://niederhausen.github.io/BSTA_526_W26/) if you want more notes, videos, etc.
- You can check out [Dr. Jessica's R class page from 2022](https://sph-r-programming-2022.netlify.app/) if you want more notes, videos, etc.
