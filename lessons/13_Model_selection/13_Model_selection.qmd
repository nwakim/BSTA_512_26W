...
## Example of a table for model fit statistics {.smaller}
...
model2 = gapm %>% lm(formula = life_exp ~ cell_phones_100 + vax_rate)
model3 = gapm %>% 
  lm(formula = life_exp ~ cell_phones_100 + vax_rate + freedom_status + income_level_4)

fit_stats = data.frame(Model = c("Model 1: CP only", "Model 2: CP + VR", "Model 3: CP + VR + FS + IL"), 
