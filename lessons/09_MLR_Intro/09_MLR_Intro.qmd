...
4.  Fit MLR model (in `R`) with two continuous predictors.
5.  Interpret MLR coefficient estimates from model with two continuous predictors.
...
## We have seen some work with these variables

- We have looked at some of the "simple" linear regression relationships between life expectancy and these variables (e.g. cell phones, income level, vaccination rate)
...
#| fig-height: 5
#| code-fold: true
#| code-summary: "Code: Create three SLR plots for life expectancy vs. cell phones, income level, and vaccination rate"
...
## How can we model life expectancy with cell phones and income level?
