...
significant association between life expectancy and number of cell phones per 100 people (p-value \< 0.0001).
...
`r round(Y60, 3)` &\pm `r round(tstar, 3)` \cdot s_{residuals} \sqrt{\frac{1}{n} + \frac{(X^* - \bar{x})^2}{(n-1)s_x^2}}\\
