...
-   [Meike's BSTA 511 page](https://niederhausen.github.io/BSTA_511_F25/)

-   [Nicky's EPI 525 page](https://nwakim.github.io/EPI_525_25F/)
...
ggplot(data = dds.discr, 
       aes(x = age)) +
  geom_histogram() +
  theme(text = element_text(size=20)) + # me making the text larger
  labs(x = "Age", # me adding labels
       y = "Count", 
