...
-   Required tables & figures
    -   Table 1 summarizing participant characteristics (from Lab 1)
    -   Figure of plot showing the relationship between the explanatory variable and IAT score with interaction as color
        - This should be a scatter plot with mean IAT on the y-axis, explanatory variable on the x-axis, and color by interaction
    - Table or figure with coefficient estimates from regression
        - You will need to organize and present this for the three models you ran: unadjusted, adjusted, and interaction
        -   Can be a forest plot
            -   If you have A LOT of coefficient estimates, the forest plot may not work well!
    - Table comparing model fit statistics
        -   This should include the unadjusted, adjusted, and interaction models
        -   Include AIC, BIC, and R-squared
-   Optional figure: Up to 1 figure that you think is helpful in understanding the results, for example
