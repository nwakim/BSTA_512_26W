...
[You can download the `.qmd` file for this lab here.](https://github.com/nwakim/BSTA_512_26W/blob/main/labs/Lab_02.qmd) Please use the linked qmd file and not this one! (This is specifically the instructions.)
