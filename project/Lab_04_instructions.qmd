...
```{r}
#| echo: false
load(here("../Project/Some_work/Lab_4_data.rda"))
iat = iat_3
```
...
[You can download the `.qmd` file for this lab here.](https://github.com/nwakim/BSTA_512_26W/blob/main/labs/Lab_04.qmd) Please use the linked qmd file and not this one! (This is specifically the instructions.)
