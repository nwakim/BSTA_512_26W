...
This document is the instructions for the lab. You will use a cleaner version to fill in your work. [You can download the `.qmd` file for this lab here.](https://github.com/nwakim/BSTA_512_26W/blob/main/project/Lab_01.qmd) 
...
#### Article: [Implicit and explicit anti-fat bias: The role of weight-related attitudes and beliefs](https://ohsuitg-my.sharepoint.com/:b:/r/personal/wakim_ohsu_edu/Documents/Teaching/Classes/BSTA_512_26W/Student_BSTA_512/Labs/Implicit_anti_fat.pdf?csf=1&web=1&e=D3dQI6)
...
2. How is anti-fat bias, as measured by the IAT, associated with self-perception of weight?
    a. With subquestion: Does gender identity modify the above association?
...
```{r}
#| echo: false
iat_2024_raw = read_sav(file = here("../TA_files_BSTA_512/Project/data/Weight IAT.public.2024.sav"))
```
